...
// AUTOLP
// Automatically adds to the PancakeSwap-LP.
...
contract AutoLP is Context, IERC20, Ownable {
    ...
    string private _name = "AutoLP.eth.link";
    string private _symbol = "AUTOLP";
    ...
    //Total 5% => 2.5% goes to liquidity providers and 2.5% is added to liquidity pool
    uint256 public _liquidityFee = 5;
    uint256 private _previousLiquidityFee = _liquidityFee;

    //means 50% from total collected liquidity (5% on every Transfer) will be used to rewarded liquidity providers
    uint256 public _lpRewardFromLiquidity = 50;
    ...
    function burnLpTokens() private {
        IPancakePair _token = IPancakePair(uniswapV2Pair);
    ...
    function LpTokenBalance() public view returns (uint256) {
        IPancakePair token = IPancakePair(uniswapV2Pair);
